...
public class Event extends ParseObject {
    ...
    /**
     * Retorna o primeiro usuÃ¡rio da relaÃ§Ã£o entre evento e usuÃ¡rio, ou seja o dono do evento
     */
    public final User getOwner() throws ParseException {
        final ParseRelation<User> a = getRelation("owner");
        // Essa query Ã© sÃ­ncrona
    ...
    public final Notification addParticipant(final User guest, final User host) {
        if (isFull()) {
            return new Notification(host, this, "O evento estÃ¡ cheio.");
        }
    ...
    /**
     * Retorna true caso {@code user} Ã© o dono do evento.
     *
     * @param user the user
