...
//	}
	...
	public void testGetOwnerName() {
		Assert.assertEquals("Event getOwnerName not working. ", "User1 name", event1.getOwnerName());
	}
	
	@Test
	public void testSetOwnerName() {
		event1.setOwnerName("New User1 name");
		Assert.assertEquals("Event setOwnerName not working. ", "New User1 name", event1.getOwnerName());
		Assert.assertNotSame("Event setOwnerName not working. ", "User1 name", event1.getOwnerName());
	}
	
	@Test
	public void testGetName() {
		Assert.assertEquals("Event getName not working. ", "Event Name 1", event1.getName());
	}
	
	@Test
	public void testSetName() {
		event1.setName("New Event1 name");
		Assert.assertEquals("Event SetName not working. ", "New Event1 name", event1.getName());
		Assert.assertNotSame("Event setName not working. ", "Event Name 1", event1.getName());
	}
	
	@Test
	public void testGetNote() {
		Assert.assertEquals("Event getNote not working. ", "Event Note 1", event1.getNote());
	}
	
	@Test
	public void testSetNote() {
		event1.setNote("New Event1 Note");
		Assert.assertEquals("Event SetNote not working. ", "New Event1 Note", event1.getNote());
		Assert.assertNotSame("Event setNote not working. ", "Event Note 1", event1.getNote());
	}
	
	@Test
	public void testGetDescription() {
		Assert.assertEquals("Event getDescription not working. ", "Event 1 Description", event1.getDescription());
	}
	...
	public void testGetInitialDate() throws ParseException {
		Assert.assertEquals("Event getInitialDate not working. ", formatter.parse("03/15/15"), event1.getInitialDate());
	}
	
	@Test
	public void testSetInitialDate() throws ParseException {
		event1.setInitialDate(formatter.parse("03/16/15"));
		Assert.assertEquals("Event setInitialDate not working. ", formatter.parse("03/16/15"), event1.getInitialDate());
		Assert.assertNotSame("Event setInitialDate not working. ", formatter.parse("03/15/15"), event1.getInitialDate());
	}
	
	@Test
	public void testGetFinalDate() throws ParseException {
		Assert.assertEquals("Event getfinalDate not working. ", formatter.parse("03/15/15"), event1.getFinalDate());
	}
